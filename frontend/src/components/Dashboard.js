...
function Dashboard({ currentModel, results = [] }) {
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      try {
        ...
        const exoplanetsFound = results.filter(
          result => result.prediction && result.prediction.is_exoplanet
        ).length;
    ...
    <DashboardContainer>
      ...
      <SectionGrid>
        <Section>
          ...
          <RecentActivity searchResults={results} />
        </Section>
